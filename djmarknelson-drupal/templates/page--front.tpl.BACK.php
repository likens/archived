    ...
    <header class="header" role="banner">
      <nav role="navigation" class="navigation home">
        <a href="#intro" class="home">
          <span>DJ Mark Nelson</span>
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="797.000000pt" height="199.000000pt" viewBox="0 0 797.000000 199.000000" preserveAspectRatio="xMidYMid meet">
            <g class="logo-path" transform="translate(0.000000,199.000000) scale(0.100000,-0.100000)" stroke="none">
    ...
    <main class="main home" role="main">
      ...
      <div class="intro" id="intro">   
        <div class="svgs">
          <svg version="1.0" class="black-1" xmlns="http://www.w3.org/2000/svg" width="797.000000pt" height="199.000000pt" viewBox="0 0 797.000000 199.000000" preserveAspectRatio="xMidYMid meet">
          ...
          <svg version="1.0" class="ice-blue" xmlns="http://www.w3.org/2000/svg" width="797.000000pt" height="199.000000pt" viewBox="0 0 797.000000 199.000000" preserveAspectRatio="xMidYMid meet">
            <g transform="translate(0.000000,199.000000) scale(0.100000,-0.100000)" stroke="none">
              <path d="M630 1635 l-354 -355 -138 0 c-101 0 -138 -3 -138 -12 0 -7 67 -80
              150 -163 l149 -151 213 213 213 213 5 -214 5 -215 223 215 222 216 1 -194 c1
              -106 4 -262 8 -346 l6 -153 458 458 457 458 0 -133 0 -132 -103 0 -102 0 -128
          ...
          <svg version="1.0" class="black-2" xmlns="http://www.w3.org/2000/svg" width="797.000000pt" height="199.000000pt" viewBox="0 0 797.000000 199.000000" preserveAspectRatio="xMidYMid meet">
            <g transform="translate(0.000000,199.000000) scale(0.100000,-0.100000)" stroke="none">
              <path d="M630 1635 l-354 -355 -138 0 c-101 0 -138 -3 -138 -12 0 -7 67 -80
              150 -163 l149 -151 213 213 213 213 5 -214 5 -215 223 215 222 216 1 -194 c1
              -106 4 -262 8 -346 l6 -153 458 458 457 458 0 -133 0 -132 -103 0 -102 0 -128
        ...
        <!-- <p class="welcome">Pursue your dreams below...</p> -->
        <ul role="menu">
          <li role="menuitem"><a href="#mixes" class="mixes">Mixes</a></li>
          <li role="menuitem"><a href="#blog" class="blog">Blog</a></li>
          <li role="menuitem"><a href="#contact" class="contact">Contact</a></li>
      ...
      <section id="contact">
        <div class="content">
          ...
          <div class="social">
            ...
            <p>Find Mark on these networks!</p>
            <a class="twitter" href="http://www.twitter.com/DJMarkNelson" target="_blank">Twitter</a>
            <a class="facebook" href="https://www.facebook.com/pages/Mark-Nelson-aka-DJ-Transcend/273021290268" target="_blank">Facebook</a>
            <a class="twitch" href="http://www.twitch.tv/iceman_1h" target="_blank">Twitch</a>
            <a class="futurefm" href="http://www.thefuture.fm/djs/marknelson" target="_blank">FutureFM</a>
            <a class="mixcloud" href="http://www.mixcloud.com/DJMarkNelson/" target="_blank">Mixcloud</a>
          </div>
          <div class="form">
            
            <p>For bookings / general contact, use the form below or email Mark at <a href="mailto:mark@djmarknelson.com">mark[at]djmarknelson.com</a></p>
              
            <form name="form" method="post" action="themes/djmn/templates/form.php">
      ...
      <div class="info">
        ...
        <div class="title">
          <ul>
            ...
            <li class="name">The Pursuit of Dreams</li>
            <li class="artist">Mark Nelson</li>
          </ul>
        </div>
      </div>

      <audio id="djmnAudio" controls="controls" preload="auto" class="mejs-player" data-mejsoptions='{"alwaysShowControls": true, "startVolume": 0, "loop": false, "audioHeight": 57}'>
        <source src="" type="audio/mpeg; codecs='mp3'" />
      </audio>

      <div class="list-btn">
        <a href="javascript:void(0)">playlist</a>
        <span>playlist</span>
      </div>
