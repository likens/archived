...
<header class="header" role="banner">
  <nav role="navigation" class="navigation">
    ...
    <ul role="menu">
      <li role="menuitem"><a href="/mixes" class="mixes active">Mixes</a></li>
      <li role="menuitem"><a href="/blog" class="blog">Blog</a></li>
      <li role="menuitem"><a href="/contact" class="contact">Contact</a></li>
      <li role="menuitem"><a href="/gallery" class="gallery">Gallery</a></li>
    </ul>
  </nav>
</header>


<main class="main page listing" role="main">
	<div class="wrapper">
		<section class="<?php print $classes; ?>" role="list">
