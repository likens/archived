...
<html lang="en">
	<head>
		<title><?php if ($title) {echo $title." // Caleb Likens // Front End Developer";} else {echo "Caleb Likens // Front End Developer";} ?> </title>
	...
	<body data-state="nav-closed">
		<header class="header" role="banner">
			...
			<nav class="nav" role="navigation">
				<ul>
					<li><a href="/" title="Home">likens<span>dot</span>co</a></li>
